...
.dx-gantt .dx-gantt-splitter {
  width: 4px;
  background-color: rgba(3, 169, 244, 0.5);
}
.dx-gantt .dx-gantt-splitter-transparent {
  background-color: transparent;
}
.dx-gantt .dx-gantt-splitter-border {
  border-left: 2px solid #e0e0e0;
}
...
.dx-gantt .dx-gantt-taskWrapper .dx-gantt-taskTitle,
.dx-gantt .dx-gantt-taskWrapper .dx-gantt-taskRes {
  font-size: 0.95em;
}
...
.dx-gantt.dx-gantt-dark .dx-gantt-altRow,
.dx-gantt.dx-gantt-dark .dx-gantt-collapsable-row {
  background-color: #ffffff;
}
